...
-->
    ...
    <link rel="stylesheet" href="{{asset('ui/assets/css/templatemo-breezed.css')}}">

    <link rel="stylesheet" href="{{asset('ui/assets/css/owl-carousel.css')}}">

    <link rel="stylesheet" href="{{asset('ui/assets/css/lightbox.css')}}">
    ...
    <!-- jQuery -->
    <script src="{{asset('ui/assets/js/jquery-2.1.0.min.js')}}"></script>

    <!-- Bootstrap -->
    <script src="{{asset('ui/assets/js/popper.js')}}"></script>
    <script src="{{asset('ui/assets/js/bootstrap.min.js')}}"></script>

    <!-- Plugins -->
    <script src="{{asset('ui/assets/js/owl-carousel.js')}}"></script>
    <script src="{{asset('ui/assets/js/scrollreveal.min.js')}}"></script>
    <script src="{{asset('ui/assets/js/waypoints.min.js')}}"></script>
    <script src="{{asset('ui/assets/js/jquery.counterup.min.js')}}"></script>
    <script src="{{asset('ui/assets/js/imgfix.min.js')}}"></script> 
    <script src="{{asset('ui/assets/js/slick.js')}}"></script> 
    <script src="{{asset('ui/assets/js/lightbox.js')}}"></script> 
